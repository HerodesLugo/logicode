          ...
          <div className="px-6 py-8 pb-10 shrink-0 flex items-center gap-3 mt-auto">
            ...
            >
              <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 17h6.498" />
              </svg>
            </button>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-110 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-[#f4f7f5] dark:bg-[#0c121b] border border-transparent dark:border-[#1e2a38] w-full max-w-sm rounded-[24px] overflow-hidden flex flex-col p-8 shadow-2xl">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-heading dark:text-white text-lg font-bold">Select Language</h3>
              <button
            ...
            <div className="flex flex-col gap-6">
               <button onClick={() => setIsLanguageModalOpen(false)} className="text-left text-body dark:text-gray-300 hover:text-heading dark:hover:text-white transition-colors text-[16px] font-medium">Spanish</button>
               <button onClick={() => setIsLanguageModalOpen(false)} className="text-left text-body dark:text-gray-300 hover:text-heading dark:hover:text-white transition-colors text-[16px] font-medium">English</button>
            </div>
          </div>
        </div>
      )}
